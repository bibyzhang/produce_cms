...
(function () {
    ...
    var tmp = window.location.pathname;
        ...
        var web_root = tmp.substr(0,tmp.lastIndexOf("\/")+1);
        var ueditor_path = "template/common/UEditor/";
        URL = window.UEDITOR_HOME_URL || web_root + ueditor_path;
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,web_root : web_root     //自行添加的网站根目录
        ,ueditor_path : ueditor_path  //自行添加的编辑器目录，相对于根目录的
        ...
        //图片上传配置区
        ,imageUrl:web_root + "app_admin.php?a=UEditor&f=imageUp"   //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                              //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:web_root + "app_admin.php?a=UEditor&f=scrawlUp" //涂鸦上传地址
        ,scrawlPath:""                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:web_root + "app_admin.php?a=UEditor&f=fileUp"    //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:web_root + "app_admin.php?a=UEditor&f=getRemoteImage"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:web_root + "app_admin.php?a=UEditor&f=imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: host                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: web_root + "app_admin.php?a=UEditor&f=imageUp" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath:""
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:web_root + "app_admin.php?a=UEditor&f=imageUp"       //word转存提交地址
        ,wordImagePath:""                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:web_root + "app_admin.php?a=UEditor&f=getMovie"                   //视频数据获取地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion','scrawl', 'insertvideo', 'attachment', 'map', 'gmap', 'insertframe','highlightcode','template', '|',
